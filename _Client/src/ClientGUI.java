...
public class ClientGUI {
    ...
    public ClientGUI(Main main){
        ...
        chat.add("[System] Connect to server with: /connect [IP address] (port)");
        chat.add("[System] View additional commands with: /help");
        currentString = new StringBuilder();
        currentString.append(username + "> ");
        followChat = true;
    }
    ...
    public void keyPressed(KeyEvent e){
        switch (e.getKeyCode()){
            case KeyEvent.VK_ENTER:
                ...
                client.processInput(s.substring(s.indexOf(">") + 2));
                currentString = new StringBuilder();
                currentString.append(username).append("> ");
                break;
    ...
    public String trimString(String string, int maxWidth){
